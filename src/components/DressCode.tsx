...
interface DressCodeConfig {
  title: string;
  note: string;
  colors: string[];
}

export default function DressCode({ config }: { config?: DressCodeConfig }) {
  ...
  return (
    <div className="bg-neutral-900/80 p-10 md:p-14 rounded-[2rem] border border-white/10 text-center max-w-3xl mx-auto relative overflow-hidden transform-gpu">
      ...
      <h2 className="text-4xl md:text-5xl font-serif mb-8 text-white">{title}</h2>
